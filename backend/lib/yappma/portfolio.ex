defmodule Yappma.Portfolio do
  ...
  alias Yappma.Repo
  alias Yappma.Portfolio.{Asset, AssetType, SecurityAsset, InsuranceAsset, LoanAsset, RealEstateAsset}
  alias Yappma.Analytics.AssetSnapshot
