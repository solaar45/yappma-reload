defmodule WealthBackend.BankConnections do
  ...
  Provides a unified interface for managing bank connections via PSD2/Styx,
  integrating seamlessly with the existing WealthBackend.Accounts context.
  """

  alias WealthBackend.BankConnections.{StyxClient, ConsentManager, AccountSync}
  ...
  2. Stores/updates them in YAPPMA database using WealthBackend.Accounts
  3. Creates account snapshots with current balances
  4. Fetches and stores transactions (TODO)
  """
