...
<div class="hero min-h-screen bg-base-200">
	<div class="hero-content text-center">
		<div class="max-w-md">
			<h1 class="text-5xl font-bold">YAPPMA Reload 🚀</h1>
			<p class="py-6">
				DaisyUI ist erfolgreich eingerichtet! Counter: <span class="badge badge-primary">{count}</span>
			</p>
			<button class="btn btn-primary" on:click={() => count++}>
				Click me!
			</button>
			<button class="btn btn-secondary ml-2" on:click={() => count = 0}>
				Reset
			</button>
			
			<div class="divider">Demo Components</div>
			...
			<div class="alert alert-info mt-4">
				...
				<span>DaisyUI + Svelte 5 + Tailwind v3 läuft perfekt!</span>
			</div>
		</div>
